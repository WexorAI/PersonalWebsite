...
export const metadata = {
  title: "about page",
  description:
    "Your Technological Transformation Partner.. At WexorAI, our passion lies in revolutionizing businesses through advanced technology",
  alternates: {
    canonical: `https://wexorai.com/About`,
  },
};
function About() {
  return (
